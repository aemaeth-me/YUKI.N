---
title: Memory | Developer Documentation
---
...
Lastly, there are cases ([like human-in-the-loop](/python/framework/understanding/agent/human_in_the_loop/index.md)) where you will need to provide both the `Context` (to resume the workflow) and the `Memory` (to store the chat history).
...
- [Memory](/python/examples/memory/memory/index.md)
- [Manipulating Memory at Runtime](/python/examples/memory/custom_memory/index.md)
- [Limiting Multi-Turn Confusion with Custom Memory](/python/examples/memory/custom_multi_turn_memory/index.md)

**NOTE:** Deprecated examples:

- [Chat Memory Buffer](/python/examples/agent/memory/chat_memory_buffer/index.md)
- [Chat Summary Memory Buffer](/python/examples/agent/memory/summary_memory_buffer/index.md)
- [Composable Memory](/python/examples/agent/memory/composable_memory/index.md)
- [Vector Memory](/python/examples/agent/memory/vector_memory/index.md)
- [Mem0 Memory](/python/examples/memory/mem0memory/index.md)
